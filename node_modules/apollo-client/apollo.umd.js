...
function queries(previousState, action) {
    ...
    if (isQueryInitAction(action)) {
        ...
        newState[action.queryId] = __assign$7({}, previousState[action.queryId], { networkError: null, graphQLErrors: resultHasGraphQLErrors ? action.result.errors : null, previousVariables: null, networkStatus: exports.NetworkStatus.ready });
        return newState;
    }
