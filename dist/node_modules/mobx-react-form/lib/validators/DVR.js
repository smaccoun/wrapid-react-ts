...
var DVR = function () {
    ...
    _createClass(DVR, [{
            ...
            value: function assignInitData(plugin, _ref) {
                var _ref$options = _ref.options, options = _ref$options === undefined ? {} : _ref$options, _ref$promises = _ref.promises, promises = _ref$promises === undefined ? [] : _ref$promises;
            ...
            value: function validateFieldSync(field, form, data) {
                ...
                if ((0, _isEmpty3.default)($rules[0]))
                    return;
            ...
            value: function rules(_rules, type) {
                ...
                if (type === 'sync')
                    diff = (0, _difference3.default)($rules, this.asyncRules);
                if (type === 'async')
                    diff = (0, _intersection3.default)($rules, this.asyncRules);
                return diff;
            }
        }, {
            key: 'loadingMessage',
