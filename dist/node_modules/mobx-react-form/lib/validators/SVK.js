...
var SVK = function () {
    ...
    _createClass(SVK, [{
            ...
            value: function assignInitData(plugin, _ref) {
                var _ref$options = _ref.options, options = _ref$options === undefined ? {} : _ref$options, _ref$schema = _ref.schema, schema = _ref$schema === undefined ? {} : _ref$schema, _ref$promises = _ref.promises, promises = _ref$promises === undefined ? [] : _ref$promises;
                options.set({
                    ajv: {
                        v5: true,
                        allErrors: true,
            ...
            value: function handleSyncError(field, errors) {
                ...
                if ((0, _isUndefined3.default)(fieldErrorObj))
                    return;
